...
export class User {
  ...
  @Prop({
    type: [{ type: mongoose.Schema.Types.ObjectId, ref: Community.name }],
  })
  communities: Community[];

  @Prop({
    type: [{ type: mongoose.Schema.Types.ObjectId, ref: NewsChannel.name }],
  })
  ...
  @Prop()
  modifyCountryCode: string;

  @Prop()
  lastTimeModifyPhoneNumber: Date;
  ...
  userJobExperience?: Array<Object>;
}
